...
(function () {
    ...
    core.run(["$translate", "$rootScope", "$timeout", "$cookies", "$auth", "CONFIG", "timezone", "lang", "config", "init", function($translate, $rootScope, $timeout, $cookies, $auth, CONFIG, timezone, lang, config, init) {
...
$templateCache.put('app/components/plaque-secure/plaque-secure.html','<div class="plaque-secure plaque-secure--danger" ng-if="vm.$auth.user.signedIn && vm.isRouteResolved() && vm.CONFIG.domainZone === \'md\'"><div class="plaque-secure__body"><div>\u0412\u0430\u0448 \u0430\u043A\u043A\u0430\u0443\u043D\u0442 \u043D\u0435\u0434\u043E\u0441\u0442\u0430\u0442\u043E\u0447\u043D\u043E \u0437\u0430\u0449\u0438\u0449\u0435\u043D. \u041F\u0435\u0440\u0435\u0439\u0434\u0438\u0442\u0435 \u0432 \u0440\u0430\u0437\u0434\u0435\u043B <button class="btn btn--size_l btn--yellow" password-change-link>\u0411\u0435\u0437\u043E\u043F\u0430\u0441\u043D\u043E\u0441\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442\u0430</button> \u0438 \u0434\u043E\u0431\u0430\u0432\u044C\u0442\u0435 \u0430\u043B\u044C\u0442\u0435\u0440\u043D\u0430\u0442\u0438\u0432\u043D\u044B\u0439 email.</div></div></div>');
