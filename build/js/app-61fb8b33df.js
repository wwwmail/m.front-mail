...
angular.module('app.core').run(['$templateCache', function($templateCache) {$templateCache.put('app/mail/mail.html','<div class="main-layout"><section class="main-layout__header"><header folder="vm.folder"></header><!-- \u041E\u0441\u043D\u043E\u0432\u043D\u043E\u0435 \u043C\u0435\u043D\u044E--><nav class="main-layout__menu" ng-class="{\'main-layout__menu--is-active-menu\': isOpenMenu}"><div class="main-layout__menu-content"><menu-main></menu-main></div><button class="main-layout__menu-closer btn--not-events btn--not-style" type="button" ng-click="vm.closeMenu()"></button></nav></section><main class="main-layout__inner"><ui-view></ui-view></main></div><div class="menu-bottom-bg" ng-if="isMenuBottomOpen"></div>');
$templateCache.put('app/auth/view.html','<div class="auth-layout"><ui-view></ui-view></div>');
