...
$templateCache.put('app/components/inbox-message/inbox-message.html','<div class="inbox-message inbox-message--new" ng-class="{\'inbox-message--importmant\': vm.message.isImportmant,\n                \'inbox-message--new\': vm.message.active,\n                \'inbox-message--checked\': vm.messages.isChecked}" ng-mouseover="vm.message.hover = true" ng-mouseleave="vm.message.hover = false" inbox-message-hover ng-click="vm.goToUrl()"><!-- \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 --><div class="inbox-message__left"><label ng-click="$event.stopPropagation();"><div class="inbox-message__avatar"><div class="avatar avatar--settings avatar--size42 avatar--second-style mrg__auto"><img class="avatar__image" src="/images/avatar-personal.svg"><div class="inbox-message__check-message"></div><input type="checkbox" style="display: none" ng-model="vm.messages.isChecked" data-checklist-model="vm.messages.checked" data-checklist-value="vm.message"></div></div></label><div class="inbox-message__round"><div class="round round--border" ng-class="{\'round--yellow\': !vm.message.seen}"></div></div></div><!-- \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A --><div class="inbox-message__center"><div class="inbox-message__head"><!----><div class="inbox-message__importance" ng-if="vm.message.important"><span class="important-tags important-tags--active"></span></div><!----><div class="inbox-message__name">{{ vm.message.from }}</div><!----><div class="inbox-message__data">{{ vm.getDate(vm.message.date.date) }}</div></div><div class="inbox-message__text"><div class="inbox-message__subject">{{ vm.message.Subject }}</div><div class="inbox-message__message"><div ng-bind-html="vm.message.message"></div></div></div><div class="inbox-message__labels"><div class="inbox-message__label letter-tags" ng-repeat="tag in vm.message.tags track by $index" style="background: {{ tag.bgcolor }}"><span class="letter-tags__name">{{ tag.tag_name }}</span> <svg class="letter-tags__icon"><use xlink:href="#ico_label-message" style="fill: {{ tag.bgcolor }}"></use></svg></div></div></div><!-- \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E --><div class="inbox-message__right"><button class="inbox-message__right__btn btn btn--size_m btn--not-style btn--size_28 icon-more"></button></div></div>');
...
$templateCache.put('app/components/inbox-message-list/inbox-message-list.html','<div class="inbox-message-list"><inbox-message message="message" ng-repeat="message in vm.messages.items"></inbox-message><!--    <div class="inbox-message inbox-message&#45;&#45;new">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;border"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;new">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;yellow"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;importmant">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;yellow"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;checked">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;border"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;checked">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;border"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;new">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;border"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;importmant">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;yellow"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;importmant">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;yellow"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>\n\n\n    <div class="inbox-message inbox-message&#45;&#45;importmant">\n\n        &lt;!&ndash; \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 &ndash;&gt;\n        <div class="inbox-message__left">\n\n            <div class="inbox-message__avatar">\n                <div class="avatar avatar&#45;&#45;settings avatar&#45;&#45;size42 avatar&#45;&#45;second-style mrg__auto">\n                    <img class="avatar__image" src="/images/avatar-personal.svg">\n                    <div class="inbox-message__check-message"></div>\n                </div>\n\n            </div>\n\n            <div class="inbox-message__round">\n                <div class="round round&#45;&#45;yellow"></div>\n            </div>\n        </div>\n\n        &lt;!&ndash; \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A &ndash;&gt;\n        <div class="inbox-message__center">\n\n            <div class="inbox-message__head">\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__importance">\n                    <span class="important-tags important-tags&#45;&#45;active"></span>\n                </div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__name">John Doe</div>\n                &lt;!&ndash;&ndash;&gt;\n                <div class="inbox-message__data">\n                    30 \u043C\u0430\u0440\n                </div>\n            </div>\n\n            <div class="inbox-message__text">\n                <div class="inbox-message__subject">Subject</div>\n                <div class="inbox-message__message">\n                    Lorem ipsum dolor sit amet, timeam appellantur nec te, et agam quot conclusionemque pri, mea eu propriae oportere interpretaris. In nec quidam eleifend partiendo.\n                </div>\n            </div>\n\n            <div class="inbox-message__labels">\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;red">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;orange">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;space-gray">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;green">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n                <div class="inbox-message__label letter-tags letter-tags&#45;&#45;purpure">\n                    <span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span>\n                    <svg class="letter-tags__icon">\n                        <use xlink:href="#ico_label-message"></use>\n                    </svg>\n                </div>\n\n            </div>\n\n        </div>\n\n        &lt;!&ndash; \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E &ndash;&gt;\n        <div class="inbox-message__right">\n            <button class="inbox-message__right__btn btn  btn&#45;&#45;size_m btn&#45;&#45;not-style btn&#45;&#45;size_28 icon-more"></button>\n        </div>\n\n    </div>--></div>');
...
$templateCache.put('app/layout/menu-main/menu-main.html','<div class="menu-main-layout scrollables"><!-- \u0445\u0435\u0434\u0435\u0440 \u043C\u0435\u043D\u044E--><div class="menu-main-layout__header"><img class="menu-main-layout__header__logo img-responsive" src="/images/logo.png"></div><div class="menu-main-layout__user-info"><div class="menu-main-layout__avatar"><div class="avatar avatar--size68 avatar--second-style"><!--<img class="avatar__image" src="/images/avatar-personal.svg" alt="">--> <img class="avatar__image" ng-src="{{ vm.user.profile.photo }}" fallback-src="{{\'/images/avatar-personal.svg\'}}"></div><button class="menu-main-layout__add-user icon-cancel btn--circle btn--size_53 rotate--am90"></button></div><span class="menu-main-layout__user-name mrg__top10">{{ vm.user.profile.username }}</span> <span class="menu-main-layout__user-mail">{{ vm.user.profile.email }}</span></div><!--\u043E\u0441\u043D\u043E\u0432\u043D\u043E\u0435 \u043C\u0435\u043D\u044E --><div class="menu-main-layout__item"><ul class="menu-main"><li class="menu-main__item" ng-repeat="folder in vm.folders.items"><div class="menu-main__item__content" ng-if="!folder.isSub"><a class="menu-main__link" ui-sref="mail.inbox({mbox: folder.name, filter: undefined})"><span class="icon-inbox menu-main__icon"></span> <span class="menu-mein__title">{{ folder.caption }}</span></a><div class="menu-main__additional-option"><span class="menu-main__count">{{ folder.messagesCount }}</span></div></div><div class="menu-main__item__content" ng-if="folder.isSub"><ul class="menu-main menu-main--additional"><li class="menu-main__item"><a class="menu-main__link menu-main__link--active" ui-sref="mail.inbox({mbox: folder.name, filter: undefined})"><span class="icon-folder menu-main__icon"></span> <span class="menu-mein__title">{{ folder.caption }}</span></a><div class="menu-mein__additional-option"></div></li></ul></div></li></ul><hr class="hr hr--main-menu"><ul class="menu-main"><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" ui-sref="mail.inbox({mbox: undefined, filter: \'flagged\'})"><span class="icon-important menu-main__icon"></span> <span class="menu-mein__title">\u0412\u0430\u0436\u043D\u044B\u0435</span></a><div class="menu-main__additional-option"></div></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" ui-sref="mail.inbox({mbox: undefined, filter: \'attaches\'})"><span class="icon-clip menu-main__icon"></span> <span class="menu-mein__title">\u0421 \u0432\u043B\u043E\u0436\u0435\u043D\u0438\u044F\u043C\u0438</span></a></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" ui-sref="mail.inbox({mbox: undefined, filter: \'unseen\'})"><span class="icon-unread menu-main__icon"></span> <span class="menu-mein__title">\u041D\u0435\u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043D\u044B\u0435</span></a></div></li></ul><!-- --><hr class="hr hr--main-menu"><!-- --><ul class="menu-main"><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" href=""><span class="icon-tag-solid menu-main__icon menu-main__icon--select"></span> <span class="menu-mein__title">\u041F\u043E\u0437\u0436\u0435</span></a></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" href=""><span class="icon-filter menu-main__icon"></span> <span class="menu-mein__title">\u0424\u0438\u043B\u044C\u0442\u0440\u044B</span></a><div class="menu-main__additional-option"><div class="radio-button"><input type="checkbox" name="fiter" class="radio-button__checkbox" id="filter-switch" checked="checked"><label class="radio-button__label" for="filter-switch"><span class="radio-button__inner"></span> <span class="radio-button__switch"></span></label></div></div></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" href=""><span class="icon-settings menu-main__icon"></span> <span class="menu-mein__title">\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438</span></a></div></li></ul></div><!--\u0444\u0443\u0442\u0435\u0440--><div class="menu-main-layout__footer-menu"><!-- --><hr class="hr hr--main-menu"><div class="mrg__left10 mrg__top10 mrg__bottom5"><span class="">\u041F\u043E\u043B\u043D\u0430\u044F |</span> <span class="font__normal">\u041C\u043E\u0431\u0438\u043B\u044C\u043D\u0430\u044F v 1.0</span></div></div><div class="scrollables--y"></div></div>');
