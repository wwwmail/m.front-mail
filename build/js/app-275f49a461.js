...
$templateCache.put('app/components/inbox-message/inbox-message.html','<div class="inbox-message inbox-message--new" ng-class="{\'inbox-message--importmant\': vm.message.isImportmant,\n                \'inbox-message--new\': vm.message.active,\n                \'inbox-message--checked\': vm.messages.isChecked}" ng-mouseover="vm.message.hover = true" ng-mouseleave="vm.message.hover = false" inbox-message-hover ng-click="vm.goToUrl()"><!-- \u0411\u043B\u043E\u043A \u0441\u0435\u043B\u0435\u043A\u0442\u0430 \u0438 \u0430\u0432\u0430\u0442\u0430\u0440\u043A\u0438 --><div class="inbox-message__left"><label><div class="inbox-message__avatar"><div class="avatar avatar--settings avatar--size42 avatar--second-style mrg__auto"><img class="avatar__image" src="/images/avatar-personal.svg"><div class="inbox-message__check-message"></div><input type="checkbox" style="display: none" ng-model="vm.messages.isChecked" data-checklist-model="vm.messages.checked" data-checklist-value="vm.message"></div></div></label><div class="inbox-message__round"><div class="round round--border"></div></div></div><!-- \u041E\u0441\u043D\u043E\u0432\u0439\u043D\u043E\u0439 \u0431\u043B\u043E\u043A --><div class="inbox-message__center"><div class="inbox-message__head"><!----><div class="inbox-message__importance"><span class="important-tags important-tags--active"></span></div><!----><div class="inbox-message__name">{{ vm.message.from }}</div><!----><div class="inbox-message__data">{{ vm.getDate(vm.message.date.date) }}</div></div><div class="inbox-message__text"><div class="inbox-message__subject">{{ vm.message.Subject }}</div><div class="inbox-message__message"><div ng-bind-html="vm.message.message"></div></div></div><div class="inbox-message__labels"><div class="inbox-message__label letter-tags letter-tags--red"><span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span> <svg class="letter-tags__icon"><use xlink:href="#ico_label-message"></use></svg></div><div class="inbox-message__label letter-tags letter-tags--orange"><span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span> <svg class="letter-tags__icon"><use xlink:href="#ico_label-message"></use></svg></div><div class="inbox-message__label letter-tags letter-tags--space-gray"><span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span> <svg class="letter-tags__icon"><use xlink:href="#ico_label-message"></use></svg></div><div class="inbox-message__label letter-tags letter-tags--green"><span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span> <svg class="letter-tags__icon"><use xlink:href="#ico_label-message"></use></svg></div><div class="inbox-message__label letter-tags letter-tags--purpure"><span class="letter-tags__name">\u041C\u0435\u0442\u043A\u0430 1</span> <svg class="letter-tags__icon"><use xlink:href="#ico_label-message"></use></svg></div></div></div><!-- \u0431\u043B\u043E\u043A \u043C\u0435\u043D\u044E --><div class="inbox-message__right"><button class="inbox-message__right__btn btn btn--size_m btn--not-style btn--size_28 icon-more"></button></div></div>');
...
$templateCache.put('app/layout/header/header.html','<div class="header"><div class="header__container"><div class="header__left"><button class="icon-menu btn btn--not-style header__icon" ng-click="vm.openMenu()"></button></div><div class="header__center"><span class="">\u0412\u0445\u043E\u0434\u044F\u0449\u0438\u0435</span> <span class="header__center__count-letters">28</span></div><div class="header__right"><form class="search-block widtn-inh search-block--no-active" action=""><input class="input input--no-border input--no-focus input--size_l width--all" type="text" placeholder="\u041F\u043E\u0438\u0441\u043A \u043F\u0438\u0441\u0435\u043C"> <button class="search-block__icon-close icon-cancel btn btn--not-style btn--size_s mrg__right"></button> <button class="search-block__icon icon-lens btn btn--not-style header__icon mrg__right"></button></form></div><hr class="hr hr--header"></div></div>');
...
$templateCache.put('app/layout/menu-main/menu-main.html','<div class="menu-main-layout scrollables"><!-- \u0445\u0435\u0434\u0435\u0440 \u043C\u0435\u043D\u044E--><div class="menu-main-layout__header"><img class="menu-main-layout__header__logo img-responsive" src="/images/logo.png"></div><div class="menu-main-layout__user-info"><div class="menu-main-layout__avatar"><div class="avatar avatar--size68 avatar--second-style"><img class="avatar__image" src="/images/avatar-personal.svg" alt=""></div><button class="menu-main-layout__add-user icon-cancel btn--circle btn--size_53 rotate--am90"></button></div><span class="menu-main-layout__user-name mrg__top10">John Doe</span> <span class="menu-main-layout__user-mail">john.doe@mail.cz</span></div><!--\u043E\u0441\u043D\u043E\u0432\u043D\u043E\u0435 \u043C\u0435\u043D\u044E --><div class="menu-main-layout__item"><ul class="menu-main"><li class="menu-main__item" ng-repeat="folder in vm.folders.items"><div class="menu-main__item__content" ng-if="!folder.isSub"><a class="menu-main__link" ui-sref="mail.inbox({mbox: folder.name, filter: undefined})"><span class="icon-inbox menu-main__icon"></span> <span class="menu-mein__title">{{ folder.caption }}</span></a><div class="menu-main__additional-option"><span class="menu-main__count">{{ folder.messagesCount }}</span></div></div><div class="menu-main__item__content" ng-if="folder.isSub"><ul class="menu-main menu-main--additional"><li class="menu-main__item"><a class="menu-main__link menu-main__link--active" ui-sref="mail.inbox({mbox: folder.name, filter: undefined})"><span class="icon-folder menu-main__icon"></span> <span class="menu-mein__title">{{ folder.caption }}</span></a><div class="menu-mein__additional-option"></div></li></ul></div></li><!--<li class="menu-main__item">--><!--<div class="menu-main__item__content">--><!--<a class="menu-main__link">--><!--<span class="icon-d-folder menu-main__icon"></span>--><!--<span class="menu-mein__title">\u041F\u0430\u043F\u043A\u0430</span></a>--><!--<div class="menu-main__additional-option">--><!--<span class="icon-arrow-up menu-main__icon"></span>--><!--</div>--><!--</div>--><!--<div class="menu-main__item__content">--><!--<ul class="menu-main menu-main&#45;&#45;additional">--><!--<li class="menu-main__item">--><!--<a class="menu-main__link menu-main__link&#45;&#45;active">--><!--<span class="icon-folder menu-main__icon"></span>--><!--<span class="menu-mein__title">\u041D\u043E\u0432\u0430\u044F \u041F\u0430\u043F\u043A\u0430</span></a>--><!--<div class="menu-mein__additional-option"></div>--><!--</li>--><!--</ul>--><!--</div>--><!--</li>--><!--<li class="menu-main__item">--><!--<div class="menu-main__item__content">--><!--<a class="menu-main__link">--><!--<span class="icon-sent menu-main__icon"></span>--><!--<span class="menu-mein__title">\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0435</span></a>--><!--<div class="menu-main__additional-option">--><!--<span class="menu-main__count">8</span>--><!--</div>--><!--</div>--><!--</li>--><!----><!--<li class="menu-main__item">--><!--<div class="menu-main__item__content">--><!--<a class="menu-main__link">--><!--<span class="icon-delete menu-main__icon"></span>--><!--<span class="menu-mein__title">\u0423\u0434\u0430\u043B\u0451\u043D\u043D\u044B\u0435</span></a>--><!--<div class="menu-main__additional-option">--><!--<span class="icon-brush menu-main__icon"></span>--><!--</div>--><!--</div>--><!--</li>--><!----><!--<li class="menu-main__item">--><!--<div class="menu-main__item__content">--><!--<a class="menu-main__link">--><!--<span class="icon-spam menu-main__icon"></span>--><!--<span class="menu-mein__title">\u0421\u043F\u0430\u043C</span></a>--><!--<div class="menu-main__additional-option">--><!--<span class="menu-main__count">12</span>--><!--</div>--><!--</div>--><!--</li>--><!----><!--<li class="menu-main__item">--><!--<div class="menu-main__item__content">--><!--<a class="menu-main__link">--><!--<span class="icon-draft menu-main__icon"></span>--><!--<span class="menu-mein__title">\u0427\u0435\u0440\u043D\u043E\u0432\u0438\u043A\u0438</span></a>--><!--<div class="menu-main__additional-option"></div>--><!--</div>--><!--</li>--><!--<li class="menu-main__item">--><!--<div class="menu-main__item__content">--><!--<a class="menu-main__link" href="">--><!--<span class="icon-outbox menu-main__icon"></span>--><!--<span class="menu-mein__title">\u0418\u0441\u0445\u043E\u0434\u044F\u0449\u0438\u0435</span></a>--><!--</a>--><!--</div>--><!--</li>--></ul><hr class="hr hr--main-menu"><ul class="menu-main"><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" ui-sref="mail.inbox({mbox: undefined, filter: \'flagged\'})"><span class="icon-important menu-main__icon"></span> <span class="menu-mein__title">\u0412\u0430\u0436\u043D\u044B\u0435</span></a><div class="menu-main__additional-option"><!--<span class="menu-main__count">4</span>--><!--</div>--></div></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" ui-sref="mail.inbox({mbox: undefined, filter: \'attaches\'})"><span class="icon-clip menu-main__icon"></span> <span class="menu-mein__title">\u0421 \u0432\u043B\u043E\u0436\u0435\u043D\u0438\u044F\u043C\u0438</span></a></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" ui-sref="mail.inbox({mbox: undefined, filter: \'unseen\'})"><span class="icon-unread menu-main__icon"></span> <span class="menu-mein__title">\u041D\u0435\u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043D\u044B\u0435</span></a></div></li></ul><!-- --><hr class="hr hr--main-menu"><!-- --><ul class="menu-main"><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" href=""><span class="icon-tag-solid menu-main__icon menu-main__icon--select"></span> <span class="menu-mein__title">\u041F\u043E\u0437\u0436\u0435</span></a></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" href=""><span class="icon-filter menu-main__icon"></span> <span class="menu-mein__title">\u0424\u0438\u043B\u044C\u0442\u0440\u044B</span></a></div></li><li class="menu-main__item"><div class="menu-main__item__content"><a class="menu-main__link" href=""><span class="icon-settings menu-main__icon"></span> <span class="menu-mein__title">\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438</span></a></div></li></ul></div><!--\u0444\u0443\u0442\u0435\u0440--><div class="menu-main-layout__footer-menu"><!-- --><hr class="hr hr--main-menu"><div class="mrg__left10 mrg__top10 mrg__bottom5"><span class="">\u041F\u043E\u043B\u043D\u0430\u044F |</span> <span class="font__normal">\u041C\u043E\u0431\u0438\u043B\u044C\u043D\u0430\u044F v 1.0</span></div></div><div class="scrollables--y"></div></div>');
$templateCache.put('app/mail/inbox/inbox.html','<inbox-header></inbox-header><div class="search-result" ng-if="vm.isNoResult"><strong>\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B \u043F\u043E\u0438\u0441\u043A\u0430 \xABinfo\xBB</strong></div><div class="search-result search-result--no-result" ng-if="vm.isNoResult"><strong class="font__size18">\u041D\u0435 \u043D\u0430\u0448\u043B\u043E\u0441\u044C \u043D\u0438 \u043E\u0434\u043D\u043E\u0433\u043E \u043F\u0438\u0441\u044C\u043C\u0430. \u041F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u0441\u0444\u043E\u0440\u043C\u0443\u043B\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0437\u0430\u043F\u0440\u043E\u0441 \u0438\u043D\u0430\u0447\u0435</strong><p class="color--gray mrg__top20">\u0420\u0435\u043A\u043E\u043C\u043C\u0435\u043D\u0434\u0430\u0446\u0438\u0438:</p><ul class="list-dash list-dash--gray"><li class="list-dash__item">\u0423\u0431\u0435\u0434\u0438\u0442\u0435\u0441\u044C, \u0447\u0442\u043E \u0432 \u0437\u0430\u043F\u0440\u043E\u0441\u0435 \u043D\u0435\u0442 \u043E\u0448\u0438\u0431\u043E\u043A</li><li class="list-dash__item">\u041F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u0443\u043C\u0435\u043D\u044C\u0448\u0438\u0442\u044C \u0434\u0438\u043B\u043D\u043D\u0443 \u0437\u0430\u043F\u0440\u043E\u0441\u0430</li><li class="list-dash__item">\u0415\u0441\u043B\u0438 \u0432\u044B \u043F\u043E\u043C\u043D\u0438\u0442\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u0435\u043B\u044F, \u043F\u043E\u043B\u0443\u0447\u0430\u0442\u0435\u043B\u044F, \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044F \u0444\u0430\u0439\u043B\u043E\u0432 \u0438\u043B\u0438 \u0438\u0445 \u0442\u0438\u043F, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u0432\u043E\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u044C\u0441\u044F \u0440\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u044B\u043C \u043F\u043E\u0438\u0441\u043A\u043E\u043C \u0438\u043B\u0438 \u044F\u0437\u044B\u043A\u043E\u043C \u0437\u0430\u043F\u0440\u043E\u0441\u043E\u0432</li><li class="list-dash__item">\u041F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043D\u0430\u0439\u0442\u0438 \u043D\u0443\u0436\u043D\u043E\u0435 \u043F\u0438\u0441\u044C\u043C\u043E \u0432\u0440\u0443\u0447\u043D\u0443\u044E</li></ul></div><!----><div class="inbox-list"><!--<inbox-message-list messages="vm.messages"></inbox-message-list>--><inbox-message-list messages="vm.messages"></inbox-message-list></div><div class="inbox-footer"><div class="inbox-footer__content"><button class="btn btn--red btn--size_62 btn--radius_3 icon-write" ui-sref="mail.compose"></button></div></div><div class="layout__footer"><!--<footer></footer>--></div>');
