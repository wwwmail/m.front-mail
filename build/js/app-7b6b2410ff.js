...
$templateCache.put('app/components/attach-upload/attach-upload.html','<div class="attach-upload"><div class="attach-upload__list"><div class="attach-upload__item" ng-repeat="attachment in vm.attachmentsData"><div class="attach-upload__image" ng-class="{\'attach-upload__image--shadow\': attachment.mime === \'image/jpeg\' || attachment.mime === \'image/png\'}"><img ng-src="{{ vm.getLink(attachment) }}" fallback-src="{{\'/images/upload-image.png\'}}" ng-if="attachment.mime === \'image/jpeg\' || attachment.mime === \'image/png\'"> <img src="/images/upload-file.png" ng-if="attachment.mime !== \'image/jpeg\' && attachment.mime !== \'image/png\'"></div><div class="attach-upload__name">{{ attachment.mime.split(\'/\')[1]; }}</div><div class="attach-upload__links" ng-if="!vm.isUploading"><!--<a class="attach-upload__link" href="{{ vm.getLink(attachment) }}" target="_blank">\u0421\u043A\u0430\u0447\u0430\u0442\u044C</a>--> <a class="attach-upload__delete icon-delete" href ng-click="vm.remove(attachment)"></a></div><div class="attach-upload__spinner"><spinner is-global="false" is-open="true" ng-if="vm.isUploading"></spinner></div></div></div></div>');
$templateCache.put('app/components/attach-item/attach-item.html','<div class="attach-item"><a href="http://apimail.devogic.com/mail/{{ vm.message.model.number }}?part=attach&filename={{ vm.attach.fileName }}&token={{ vm.user.access_token }}&connection_id={{ vm.message.model.connection_id }}" target="_blank"><div><div class="attach-item__image-block"><img class="attach-item__image" ng-if="vm.attach.mime === \'image/png\' || vm.attach.mime === \'image/jpeg\'" ng-src="http://apimail.devogic.com/mail/{{ vm.message.model.number }}?part=attach&filename={{ vm.attach.fileName }}&token={{ vm.user.access_token }}&connection_id={{ vm.message.model.connection_id }}"></div><div class="attach-item__name" ng-if="vm.attach.mime !== \'image/png\' && vm.attach.mime !== \'image/jpeg\'"><span class="attach-item__file-name">{{ vm.attach.fileName }}</span></div><div class="attach-item__type"><span class="attach-item__type-name">{{ vm.attach.mime.split(\'/\')[1]; }}</span></div><div class="attach-item__size">1.3kb</div><button class="attach-item__button btn--not-style btn--not-events"><span class="icon-download"></span></button></div></a></div>');
...
$templateCache.put('app/components/search-mail/search-mail.html','<!--<div class="search-mail" search-mail-open>--><!--<div class="search-mail__close" ng-if="isOpen">--><!--<button class="btn-y btn-y&#45;&#45;white btn-y&#45;&#45;close" ng-click="close()">--><!--<img class="btn-y__icon" src="/images/cancel.svg" alt="close search">--><!--</button>--><!--&lt;!&ndash;<button class="button button_theme_islands button_size_m button__control i-bem"&ndash;&gt;--><!--&lt;!&ndash;data-bem=\'{"button":{}}\' role="button" type="button"&ndash;&gt;--><!--&lt;!&ndash;ng-click="close()"><span class="button__text">&ndash;&gt;--><!--&lt;!&ndash;<img src="/images/cancel.svg" alt="close search">&ndash;&gt;--><!--&lt;!&ndash;</span>&ndash;&gt;--><!--&lt;!&ndash;</button>&ndash;&gt;--><!--</div>--><!--<div class="search-mail__group">--><!--<form ng-submit="vm.search()" novalidate>--><!--<div class="control-group" role="group">--><!--<span class="input input&#45;&#45;no-border input_theme_islands input_size_m input_type_search i-bem"--><!--data-bem=\'{"input":{}}\'><span class="input__box search-mail__input">--><!--<input class="input__control" placeholder="\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u0430\u043F\u0440\u043E\u0441" type="search"--><!--ng-model="model" ng-click="open()"/></span></span>--><!--<button class="button button_theme_islands button_size_m button__control i-bem"--><!--data-bem=\'{"button":{}}\' role="button" type="submit"--><!--ng-click="open()"><span class="button__text">\u041F\u043E\u0438\u0441\u043A</span>--><!--</button>--><!--</div>--><!--</form>--><!--</div>--><!--</div>-->');
$templateCache.put('app/components/contact-to-add-select/contact-to-add-select.html','<!--<ui-select class="select-input-line"--><!--multiple--><!--ng-model="vm.addresses"--><!--tagging="vm.makeContact"--><!--tagging-label="true"--><!--theme="bootstrap"--><!--ng-disabled="{{ vm.disabled }}">--><!--<ui-select-match class="select-input-line__match-tags">--><!--<div class="select-input-line__match-item tag-contact font-sizer&#45;&#45;bigger-15">--><!--<div class="avatar avatar&#45;&#45;size20 mrg__right7">--><!--<avatar-name name="$item.first_name" email="$item.email"></avatar-name>--><!--</div>--><!--<div class="tag-contact__name" ng-if="$item.first_name">--><!--{{ $item.first_name }}--><!--{{ $item.last_name }}--><!--</div>--><!--<div class="tag-contact__email" ng-if="!$item.first_name">--><!--{{ $item.emails[0].value }}--><!--</div>--><!--</div>--><!--</ui-select-match>--><!--<ui-select-choices class="select-input-line__choices-tags"--><!--refresh="vm.findContacts($select.search)"--><!--refresh-delay="500"--><!--repeat="contact in (vm.contacts.items | filter: $select.search) track by contact.id">--><!--<div class="select-input-line__choices-item tag-contact">--><!--<div class="avatar avatar&#45;&#45;size28 mrg__right16 avatar&#45;&#45;bg-color">--><!--<avatar-name name="contact.first_name" email="contact.email"></avatar-name>--><!--</div>--><!--<div class="tag-contact__name">--><!--{{ contact.first_name }}--><!--{{ contact.last_name }}--><!--</div>--><!--<div class="tag-contact__email">--><!--{{ contact.email }}--><!--</div>--><!--<div class="tag-contact__phone">--><!--{{ contact.phone }}--><!--</div>--><!--</div>--><!--</ui-select-choices>--><!--<div ui-select-choices-static>--><!--<div class="ui-select-choices-row pointer" ng-click="vm.openContactToAddPopup()">--><!--<div class="ui-select-choices-row-inner">--><!--<div class="select-input-line__choices-item tag-contact tag-contact&#45;&#45;more">--><!--<div class="avatar avatar&#45;&#45;size28 mrg__right16 avatar&#45;&#45;bg-color">--><!--<avatar-name name="\'Contacts\'" email="\'Contacts\'"></avatar-name>--><!--</div>--><!--<div class="tag-contact__name">--><!--<a class="link">--><!--\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0432\u0441\u0435 \u043A\u043E\u043D\u0442\u0430\u043A\u0442\u044B--><!--</a>--><!--</div>--><!--</div>--><!--</div>--><!--</div>--><!--</div>--><!--</ui-select>--><tags-input class="tags-input" ng-model="vm.addresses" type="email" template="tag-template" template-scope="vm" display-property="first_name" key-property="id" replace-spaces-with-dashes="true" allow-dblclick-to-edit="true"><auto-complete source="vm.findContacts($query)" min-length="0" load-on-focus="true" load-on-empty="true" max-results-to-show="5" template="autocomplete-template"></auto-complete></tags-input><script type="text/ng-template" id="tag-template"><div class="tag-contact font-sizer--bigger-15 tag-contact__autocomplete-item"\n         ng-dblclick="$event.stopPropagation();">\n        <div class="avatar avatar--size20 mrg__right7">\n            <avatar-name name="data.first_name" email="data.email"></avatar-name>\n        </div>\n        <div class="tag-contact__name" ng-if="data.first_name">\n            {{ data.first_name }}\n            {{ data.last_name }}\n        </div>\n        <div class="tag-contact__email" ng-if="!data.first_name">\n            {{ data.emails[0].value }}\n        </div>\n        <button class="tag-remove btn btn--not-style icon-cancel" type="button"></button>\n    </div></script><script type="text/ng-template" id="autocomplete-template"><div class="tag-contact">\n        <div class="avatar avatar--size28 mrg__right16 avatar--bg-color">\n            <avatar-name name="data.first_name" email="data.email"></avatar-name>\n        </div>\n        <div class="tag-contact__name">\n            {{ data.first_name }}\n            {{ data.last_name }}\n        </div>\n        <div class="tag-contact__email">\n            {{ data.email }}\n        </div>\n        <div class="tag-contact__phone">\n            {{ data.phone }}\n        </div>\n    </div></script><!--<script type="text/ng-template" id="autocomplete-template-footer">--><!--<div class="tag-contact tag-contact&#45;&#45;more" ng-click="vm.openContactToAddPopup()">--><!--<div class="avatar avatar&#45;&#45;size28 mrg__right16 avatar&#45;&#45;bg-color">--><!--<avatar-name name="\'Contacts\'" email="\'Contacts\'"></avatar-name>--><!--</div>--><!--<div class="tag-contact__name">--><!--<a class="link">--><!--\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0432\u0441\u0435 \u043A\u043E\u043D\u0442\u0430\u043A\u0442\u044B--><!--</a>--><!--</div>--><!--</div>--><!--</script>-->');
...
$templateCache.put('app/components/tag-list/tag-list.html','<div class="popup__head"><span class="popup__head__title">\u041C\u0435\u0442\u043A\u0438</span> <button class="icon-cancel btn btn--not-style btn--main-mobile-color btn--size_s" type="button" ng-click="vm.close()"></button><hr class="hr hr--popup"></div><div class="popup__content scrollables"><label class="tag-list__item" ng-click="vm.setImportant()"><div class="letter-tags"><span class="icon-important popup__icon popup__icon--not-size color--semi-dark-red"></span></div><span class="tag-list__title tag-list__title--mrg-left" ng-if="!vm.messages.items[0].important">\u0412\u0430\u0436\u043D\u043E\u0435</span> <span class="tag-list__title tag-list__title--mrg-left" ng-if="vm.messages.items[0].important">\u041D\u0435 \u0432\u0430\u0436\u043D\u043E\u0435</span> <input class="tag-list__checked" type="checkbox"> <span class="tag-list__tick is-selected"></span></label><label class="tag-list__item" ng-repeat="tag in vm.tags.items"><div class="letter-tags" style="color: {{ tag.bgcolor }}"><span class="letter-tags__icon icon-label-message font--size21"></span><!--<svg class="">--><!--<use xlink:href="#ico_label-message"></use>--><!--</svg>--></div><span class="tag-list__title tag-list__title--mrg-left">{{ tag.tag_name }} </span><input class="tag-list__checked" type="checkbox" ng-change="vm.triggerTag(tag, checked)" data-checklist-model="vm.unTags.items" data-checklist-value="tag"> <span class="tag-list__tick is-selected"></span></label></div><div class="popup__footer"><button class="btn btn--yellow btn--no-radius width--all height--min-inh font--size20" ng-click="vm.close()">\u0413\u043E\u0442\u043E\u0432\u043E</button></div>');
